...
void main() {
    sys_config();
    while (1) {
              _Bool bt1 = (HAL_GPIO_ReadPin(PORT_B, PIN_3) == GPIO_LOW);
             _Bool bt2 = (HAL_GPIO_ReadPin(PORT_B, PIN_4) == GPIO_LOW);
             _Bool bt3 = (HAL_GPIO_ReadPin(PORT_B, PIN_5) == GPIO_LOW);
             ...
             if (bt1 || bt2 || bt3) {
                 ...
                 if (bt1 && HAL_GPIO_ReadPin(PORT_B, PIN_3) == GPIO_LOW) {
                     ...
                     for (uint16_t i = 0; i < 500; i++) { _delay((unsigned long)((10)*(20000000/4000.0))); }
